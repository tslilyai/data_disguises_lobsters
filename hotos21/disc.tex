...
As future work, \proto can optionally allow for entities to be decorrelated without affecting queries which
...
\proto stores and separately updates answers to aggregation queries;
...
ghost stories to retain the count of stories per tag.  \proto would remove any ghost stories that
