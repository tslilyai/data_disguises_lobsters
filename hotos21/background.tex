...
\multicolumn{1}{c}{}                                                                      &
\textbf{Automated} & \textbf{De-identifies User Data} & \textbf{Retains User Data} & \textbf{Supports Resubscription}                                          &  \\ \cmidrule(r){1-5}
\textbf{\begin{tabular}[c]{@{}r@{}}Facebook/Instagram \\ Account Deletion\end{tabular}}     & \checkmark          & \checkmark                        & \checkmark                  &                                          &  \\ \cmidrule(r){1-5}
\textbf{\begin{tabular}[c]{@{}r@{}}Facebook/Instagram \\ Account Deactivation\end{tabular}} & \checkmark          &                                  & \checkmark                  & \checkmark                                &  \\ \cmidrule(r){1-5}
\textbf{\begin{tabular}[c]{@{}r@{}}Twitter \\ Account Deletion\end{tabular}}     & \checkmark          & \checkmark                        & \checkmark                  &                                          &  \\ \cmidrule(r){1-5}
\textbf{\begin{tabular}[c]{@{}r@{}}Twitter \\ Account Deactivation\end{tabular}} & \checkmark          &                                  & \checkmark                  & \checkmark                                &  \\ \cmidrule(r){1-5}
\textbf{Reddit}                                                                             & \checkmark          & \checkmark                        & \checkmark                  &                                          &  \\ \cmidrule(r){1-5}
\textbf{Hacker News}                                                                        &                    & \checkmark                        & \checkmark                  &                                          &  \\ \cmidrule(r){1-5}
