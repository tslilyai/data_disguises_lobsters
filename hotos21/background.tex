...
implement. \lyt{(This isn't exactly what I want to say---sorry, Eddie!---but something like this is
probably useful.)} When user accounts are removed, every piece of data ever associated with that
...
HotCRP developers must support unsubscription that both retains useful data for HotCRP and its
