...
%
While Sypse also relies on an object graph, its design is application-oblivious and specifying what
counts as PII is left as future work; data disguising observes that application-specific
transformations are required to maintain correct application semantics, and allows developers to
