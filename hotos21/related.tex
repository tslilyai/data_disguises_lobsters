...
%
While Sypse also relies on an object graph, its design is application-oblivious and assumes that
developers take care of splitting and moving data between the identity-revealing PII partition
and the privacy-preserving normal partition.
%
%In contrast, data disguing does not keep PII in the application, or change the application
%schema.
%%
