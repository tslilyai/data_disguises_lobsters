...
and the privacy-preserving normal partition.\lyt{I'm not sure this is accurate? They don't use
developer input at all to figure out which edges to break/columns to anonymize, but rather assume some random data synthesis + some ``automated'' analysis
of the data schema, whereas we actually assume that developers need to specify these things}
%
