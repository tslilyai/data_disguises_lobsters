...
\begin{table}[th!]
    ...
    \footnotesize
    \begin{tabular}{@{}ccccc@{}}
    App & \#Entity Types & \#Edge Types & Schema LoC & Mask LoC \\
    \midrule
    Lobsters-Decor & 19 & 20 & 318 & 220 \\
    HotCRP-Coarse & 25 & 50 & 352 & 378 \\
    HotCRP-Granular & 25 & 50 & 352 & \lyt{TODO} \\
\end{tabular}
...
conflicts, HotCRP-Decor specifies \texttt{Decorrelate} edge policies for edges from user to reviews
...
This transformation, also implemented by HotCRP-Delete policy, can lead to spurious
...
This adds a couple extra LoC to the specification, resulting in a 
