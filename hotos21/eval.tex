...
revealing users with the Lobsters-Current disguise, when the Lobsters database contains 3K users and 80K
user contributions. Disguising currently performs queries sequentially during object graph
