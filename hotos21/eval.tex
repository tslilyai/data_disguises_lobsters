...
reviews, and paper conflicts, choosing edge transformations with a sensitivity threshold of 0 for
these edge types. To retain paper and review data, these edge transformations decorrelate, rather
than delete: \sys will replace these edges with an edge to a generated ghost user profile
...
For all other edge types, we specify a sensitivity threshold of 1. This ensures that
...
%by determining which entity attributes reveal identifying information (and should be generated); which attributes should be cloned to retain information necessary to the application; and how to generate attribute values in ways that satisfy HotCRP semantics. 
