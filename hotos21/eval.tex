...
edges from the user's paper conflicts to papers (Figure~\ref{fig:hotcrp}b). 
%
...
%, which can be improved by using prepared queries and caching query results. 
%\lyt{These numbers come from lobsters running at 0.5 scale, w/0\% unsub}
Disguise application in the worst case requires creating or removing potentially as many 
guises as the number of edges connected to the target.
