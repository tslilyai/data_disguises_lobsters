...
decreases throughput by 4\% compared to a baseline without \sys. Another variant that additionally
tracks an in-memory object graph decreases throughput by 9\% compared to baseline.
...
We are investigating other designs that spreads the cost of disguising across normal execution.
%
