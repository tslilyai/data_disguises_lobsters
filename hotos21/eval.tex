...
Lobsters-Current on an object graph with 3K users and 80K total user contributions.  Revealing
batches queries by table; disguising currently applies queries during object graph traversal. Queries increase linearly with the number of objects
