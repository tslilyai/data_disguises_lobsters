...
\textbf{Lobsters} has a total of 20 entities, and a \lyt{TODO} LoC mask policy for unsubscription.
...
posts about that topic (e.g.,\ a researcher in visualization).  All edges directly to the user have
policies that decorrelate to a sensitivity threshold of 0; edges between stories and tags have
policies that decorrelate to a sensitivity threshold of 0.25 (with ghost tags generated as some
default tag); and edges between all other entities have policies that retain the edge (sensitivity
threshold of 1).
