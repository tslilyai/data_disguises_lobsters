...
Data masking transformations all have similar requirements, namely to (1) selectively
...
%serve a number of purposes, allowing users to switch between
%privacy-preserving unsubscribed mode and identity-revealing subscribed mode, inactive or stale data
%to expire, and harmful content to be hidden or modified.
%
