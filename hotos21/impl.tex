...
%-------------------------------------------------------------------------------
\label{sec:proto}
Our initial prototype data disguiser, \sys, consists of 5K LoC of Rust, and supports SQL queries as
well as \texttt{MASK [target\_id]} and \texttt{REVERSE MASK [target\_id]} queries.  \sys provides
data masking in the context of applications that use SQL relational databases, where entities are
rows in tables and edges are determined by foreign key relationships. 
%
This restriction is not fundamental: for example, a data masking system can additionally support
