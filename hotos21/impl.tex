...
%-------------------------------------------------------------------------------
\label{sec:proto}
Our prototype disguiser tool, \sys, consists of 5K LoC of Rust, and supports SQL queries as
...
%
This restriction is not fundamental: for example, a data disguiser tool can additionally support
