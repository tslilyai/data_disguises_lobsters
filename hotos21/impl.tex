...
well as \texttt{DISGUISE [target]} and \texttt{REVERSE DISGUISE [target]} queries.  \sys provides
...
%
This restriction is not fundamental: for example, \sys could additionally support abstract,
