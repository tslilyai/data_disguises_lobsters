\begin{abstract}
    ...
    To help developers flexibly support data masking in new and existing applications, we design and
    ...
    and automate practical data masking transformations without onerous labor.
\end{abstract}
