...
%
But it is hard to be a conscientious developer: privacy-enhancing data transformations require
deleting, anonymizing, and decorrelating users' data, while maintaining the data required for
legal purposes and application utility to other users.
%
Consequently, today's applications support only simple, coarse-grained, and ad-hoc privacy
transformations.
%

We propose a systematic approach, called \emph{data masking}, that helps developers generate
privacy transformations for database-backed web applications from a high-level specification
and pre-existing entity relationships.
%
Data masking tools simplify privacy transformations that applications use today; they support
fine-grained and nuanced policies that would be cumbersome to implement manually; and
they enable reversible transformations for users who change their mind.
%
