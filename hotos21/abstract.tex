...
%
This paradigm strikes a balance between the current paradigm, in which services own user data
    and users have minimal data privacy, and the other extreme, which decouples user data from
    services for strong privacy while breaking current business models and reducing service utility.
