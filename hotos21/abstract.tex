...
\ms{We should give our paradigm a name!}
    \lyt{a "Cloak" paradigm? (I've been calling it a ``subscription paradigm'' in the text, but I
    feel like subscription might be a bit overloaded as a term)}
...
%we design \sys{}, a practical system that provides abstractions and mechanisms to help
