\begin{abstract}
    ...
    remove or modify data, while still retaining data required for application
    utility or legal purposes. Because such transformations are necessarily application-specific and
    require handling complex data correlations, today's applications often forgo these
    transformations, or use ad-hoc methods with unclear guarantees to achieve them.
    %
