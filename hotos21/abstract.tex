...
%
Meeting these requirements grows only more challenging as privacy transformations become more complex;
...
To enable developers to better support existing and new, more expressive, privacy transformations without
    onerous manual labor, we propose \emph{data masking}, a systematic approach that helps
    developers generate \emph{data masks} for database-backed
    web applications from a high-level mask specification.
%
