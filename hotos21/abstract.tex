\begin{abstract}
    ...
    To help developers flexibly support data privacy transformations in new and existing
    ...
    entities}, which allow developers to express and automate practical data privacy transformations without
    onerous labor.
\end{abstract}
