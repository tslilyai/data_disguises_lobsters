\begin{abstract}
    ...
    sufficiently de-identify content, while retaining data required for application utility or legal
    ...
    applications, we propose \sys, which provides a set of abstractions and mechanisms---the
    application \emph{entity graph} and \emph{ghost entities}---and systematically automates these
    transformations.
\end{abstract}
