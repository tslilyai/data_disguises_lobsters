...
transformations} (such as user unsubscription \lyt{I'm a bit worried that people won't know what
unsubscription means; since we "unsubscribe" from mailing lists but that doesn't delete accounts})
...
%
In particular, we imagine developers who specify declaratively specify the above and other
