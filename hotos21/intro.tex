...
%
Data masking tools take a specified data mask, and automatically translates the mask into
the appropriate database transformations to achieve the masked entity graph state. With these
...
mask---determines the structure of the entity graph after the mask is applied.
...
Data masking tools take a data mask, and automatically generate and apply the mask via the
