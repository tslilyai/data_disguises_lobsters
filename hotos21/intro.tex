...
%
This transformation might be appropriate when inference would likely succeed, \eg because
a tag was created by a user,
...
or if more than a threshold percentage the tag's uses is by this user.
%
