...
web applications, creating incentives to support different forms of \emph{data privacy
transformations}. 
...
Achieving these various data privacy transformations is not easy.  For example, applications must
...
represent data privacy transformations as transformations of this graph. \emph{Ghost entities}
...
data privacy transformations efficiently, and that policies can be expressed with low burden for
