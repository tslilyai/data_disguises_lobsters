...
\lyt{I have a note here from Derek saying that transformations isn't explicitly defined; I'm not
convinced we should, but just wanted to mention it.}
%
...
%
Privacy transformations designers must correctly handle identifying data, as well as indirectly identifying
