...
nor should it make non-sensitive shared content
disappear.
%
%
...
and an anonymized order history of an e-commerce site can reidentify the buyer.
%
...
adds significant burdens to implementation.
...
\eddie{“In some cases, a policy could preserve utility while reducing the
efficacy of later inference attacks by changing posts, such as by modifying
their metadata (\eg tags, posting times). These changes might be called for
only where inference would likely succeed.” ?}
%
