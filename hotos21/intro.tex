...
\begin{itemize}[nosep]
    ...
    \item Retain users' contributions that have the same public characteristic, but ensure that they
        cannot be identified by this characteristic (\eg keep the user's posts on Reddit, but remove
        their tags).
    \item Retain users' contributions that have the same public characteristic, but ensure that they
        cannot be identified by this characteristic \emph{only if} the characteristic was created by
        the user (\eg keep the user's posts on Reddit, but remove their tags that were customized by the user).
    \item Remove users' contributions if they comprise more than $p$ percent of the contributions
        with the same public characteristic (\eg remove the user's posts on Reddit with tag $t$ if
