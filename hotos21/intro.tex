...
Data disguises are optionally reversible: \sys can record all transformations performed during the data
disguise application in an encrypted log, and reversal decrypts this log and undoes each transformation.
%
\lyt{Remove this?}
