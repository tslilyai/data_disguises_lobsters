...
%
Users---and application developers---might benefit from more nuanced and specific privacy
policies.
%
...
These envisioned privacy transformations allow applications to, \eg be more selective in the
data and structural correlations that it retains or removes upon unsubscription, and add new
policies that provide better privacy for users' data even if the user does not manually
unsubscribe.

\paragraph{Data decomposition.}
%
\ms{write about time-based transformations here. Unsubscribe after lease end, gradual reduction
of identifiable information in data, etc.}
%
