...
Data masks also go beyond just masking user data: applications increasingly apply masks to moderate harmful data (\eg inappropriate content or misinformation), hiding or modifying data contents~\cite{contentmod, sasb}.
...
To help developers of new and existing applications support data masks, we propose
