...
%
Tools for data masking take a data mask specification, and automatically translates the mask into the
appropriate database transformations. With these tools, developers reason only about constraints on
