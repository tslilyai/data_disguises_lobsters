...
\lyt{Should I cite each example's privacy policy? I just picked a handful but didn't bother
citing them yet.}

Privacy policies today often contain the following policies for user unsubscription:
\begin{itemize}
    ...
    \item Keep user contributions visible to the intended audience, but anonymized by reassociation with a global
        placeholder user (\eg Reddit, Lobsters).
    \item Keep certain user contributions unanonymized and visible to its intended audience (\eg HotCRP).
