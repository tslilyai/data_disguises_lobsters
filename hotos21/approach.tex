...
deletes it from the application.\lyt{How to avoid requiring the user to store or protect the private
key? Could cloud storage be provided by a third party?}
...
When a user resubscribes, \sys re-imports and decrypts missing data (\lyt{TODO}) and automatically
