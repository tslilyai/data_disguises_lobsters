...
Resubscription performs the inverse transformation of the graph using the log of
unsubscription graph transformations.

Modeling application data and un/resubscription as graph transformations with ghost entities allows
developers to declaratively specify the effects of unsubscription, and this specification precisely
conveys post-unsubscription privacy guarantees to users.  Developers use their application expertise
...
To further reduce developer burden, we design and implement \sys, a prototype that takes an unsubscription policy and a concrete
...
generation policies (specifying transformations of graph nodes), and edge policies (specifying
