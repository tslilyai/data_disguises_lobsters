...
Furthermore, transformations are reversible given a log of graph
...
specify the effects of the data mask. This specification acts as a precise
post-transformation privacy policy for users and developers.
Developers use their application expertise to determine an appropriate post-masking state
...
Choosing appropriate policies and reasoning about post-masking state requires the developer
...
masking policy and a concrete application schema, and automatically transforms instances of the application entity graph to achieve the state specified
in the policy (Section~\ref{sec:proto}).

%-------------------------------------------------------------------------------
\subsection{Data Masking Policies}
%-------------------------------------------------------------------------------
\label{sec:policies}
