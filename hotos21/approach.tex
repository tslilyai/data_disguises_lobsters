...
Privatization transforms this graph by introducing \emph{ghost entities}, which both
replace real entities with (partially or fully) modified content, and break structural correlations.
Data retention and data privatization (de-identification or content removal) can be fully captured
...
Modeling privatization as graph transformations with ghost entities allows
developers to declaratively specify the effects the privatization transformation, and this specification 
acts as a precise post-transformation privacy policy for users and developers. 
Developers use their application expertise to determine an appropriate post-transformation state
that balances data retention with data privatization, all while maintaining application correctness.
This state is expressed as a \emph{data privatization transformation policy}, which consists of a set of
...
privatization transformation policy and a concrete application schema, and automatically applies the
...
%-------------------------------------------------------------------------------
\subsection{Data Privatization Transformation Policies}
%-------------------------------------------------------------------------------
\label{sec:policies}

This section describes the abstractions underlying transformation policies, which consist of ghost
...
data remain as unaffected as possible by another entity's privatization.
To optimize
