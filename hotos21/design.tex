...
that have edges (foreign key relationships) to the paper.\lyt{This example might be hard to
understand, since edge policies/decorrelation haven't been introduced yet?}
