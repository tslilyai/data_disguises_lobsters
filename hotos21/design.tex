...
This section describes data masks, which consist of a set of transformation policies for each entity
type, and for each edge type.  Policies for entity types specify how to generate \emph{ghost
entities} of that type, while policies for edge types specify whether edges should be deleted,
retained, or decorrelated (and replaced with edges to ghost entities).

\lyt{I want to add snippets of pseudocode policy + a pictoral graph transformation for each type of
policy.}
