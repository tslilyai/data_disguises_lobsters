...
apply the transformation (disguise) or its reverse (reveal). The tool proxies application queries to
its data storage, and exposes ``DISGUISE'' and ``REVERSE DISGUISE" operations 
that invoke the disguise on transformation-triggering events (\eg user account deletion, data timeout, etc.).
