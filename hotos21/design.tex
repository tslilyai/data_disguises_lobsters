...
\lyt{TODO clone once always associated with non-sensitive entities if any, optimization to just keep
original entity in place and generate ghosts for other correlations that are broken}
