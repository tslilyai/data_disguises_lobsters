...
%
In Figure~\ref{fig:guises}, creating two user guises recursively creates two
...
%
Edge transformations specify how a disguise \emph{restructures} the object graph.
%
The disguise applies edge transformations while recursively traversing edges from the target.
%
% SOURCE = CHILD
% DEST = PARENT
