...
\begin{itemize}[nosep]
    \item \textbf{CloneAll:} Ghosts generated from the same template all share the template's
    ...
    \item \textbf{CloneOne:} One ghost entity shares the same value for the attribute as the
