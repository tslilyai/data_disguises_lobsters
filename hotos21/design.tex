...
removed entity data back to the unsubscribing user, encrypted using \lyt{TODO}. \sys also deletes and returns all parent entities that
...
\lyt{TODO decrypt, cloud storage, etc.?}
