...
Disguises offer developers the ability to transform guises in the following ways: they can modify
guises at per-attribute (\ie per-column)
granularity; decorrelate a guise from any guise that references it via \eg foreign-key
relationships; and remove objects entirely.
