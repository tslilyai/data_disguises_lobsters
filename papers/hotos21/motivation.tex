...
The second challenge arises because privacy transformations are inherently difficult, requiring
extensive tracing of user identities through application data schemas, and are also secondary to
