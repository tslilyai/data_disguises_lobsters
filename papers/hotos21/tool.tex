...
%systematically reason about disguises / correctness / ref integrity ==> data disguises, key point is
%guises, primitives of modify/decorrelate/delete

%disguise composition ==> user vaults, static analysis for partial undo
%- upside is reversal
%problems with mass moderation needing to affect the vault, contradictions
