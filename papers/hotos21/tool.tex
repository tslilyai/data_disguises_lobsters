...
Data disguising provides the infrastructure and mechanisms to handle data restoration necessary for
disguise composition and disguise reversibility; however, appropriately using of these to
achieve application privacy goals remains an open question, which we discuss in \S\ref{s:disc}.
