...
Providing privacy in complex, data-rich applications is hard.
%
...
interwoven state in a relational database. 
    %This is hard enough---finding the affected
Finding the affected
data can be nontrivial, and even then, privacy actions must balance competing
