...
data associated with a user also delete \emph{formerly}-associated data that
has since been anonymized?
Static analysis and other techniques may be required
