...
\subsection{Privacy Transformations as First-Class Citizens}
%
\ms{This doesn't fit well currently.}
\lyt{Took a shot a rewording/reorganizing...}
%
This survey of privacy transformations and their potential as powerful mechanisms for privacy argues
for a systematic treatment of privacy transformations that makes them a first-class citizen in
application design.
%
