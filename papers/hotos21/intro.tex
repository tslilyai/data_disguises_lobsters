...
%
It also can integrate new components, such as \emph{user vaults} (secure storage locations
for disguised data), that support more nuanced policies than most current applications.
