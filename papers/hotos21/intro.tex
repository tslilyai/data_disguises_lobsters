...
automatically decay data over time, but must still support users leaving or returning to the
application. Performing one privacy transformation should not affect the privacy properties
achieved by future transformations, even if they both transform the same data.
For example, data decay should not prevent a user from removing their data when they delete their
account.
%
