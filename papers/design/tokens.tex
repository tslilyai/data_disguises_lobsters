...
\sys encrypts private \tdata{pd} and \tpriv{pdq} tokens with a symmetric key \symk{pd} specific to
the disguise and principal: the nonce associated with the token ensures safety against
