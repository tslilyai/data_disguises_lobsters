...
Executing \rev{d_1} cannot reveal data disguised by $d_2$ (\eg, \rev{d_1} cannot recorrelate a data
object that $d_1$ decorrelated that was removed by $d_2$). To ensure that \rev{d_1} is properly
reflected when $d_2$ is reversed, \sys retroactively executes \rev{d_1} if \rev{d_2} is invoked,
using the disguise history to determine if \rev{d_1} had been invoked before.
