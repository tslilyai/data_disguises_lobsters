...
the application invokes \fn{ApplyDisguise} with the client-provided disguise indentifier, the
...
application. Applying a disguise returns the locating capability \lcapa{pd} that
...
\dcapa{p} and locating capability \lcapa{pd}. The application passes these to \sys to restore the original, undisguised data with
