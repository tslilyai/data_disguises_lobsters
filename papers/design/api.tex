...
The client-side API in Table~\ref{tab:client_api} allows the client to register a principal, retrieve relevant capabilities, and apply and reveal disguises. The server-side API in Table~\ref{tab:internal_api} allows the application/\sys to gain access to data using capabilities.
