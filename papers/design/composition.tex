...
Given two disguises $d_1$ and $d_2$ in history [\app{d_1},\app{d_2}],
...
\centering
\begin{tabular}{ c | c c }
    %\multirow{2}{}{\textbf{$d_1$ and $d_2$'s Updates}} & \multicolumn{2}{c}{\textbf{$d_1$ Token Access of Client Invoking
...
\end{tabular}
\vspace{6pt}
    \caption{\xhist{[\app{d_1},\app{d_2},\rev{d_1}]} depending on the client's access to $d_1$'s
