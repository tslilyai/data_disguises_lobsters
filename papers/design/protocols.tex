...
Figure~\ref{fig:acctreg} illustrates how every principal in the system must register a public key with \sys in order to later reveal (for disguise reversal or composition) any of privately disguised data. \sys remembers each public key \pubk{p} along with $p$'s ID.
...
Figures~\ref{fig:rpt}, \ref{fig:appdisg}, and \ref{fig:revdisg} describe how \sys implements the
functions necessary for disguising.
