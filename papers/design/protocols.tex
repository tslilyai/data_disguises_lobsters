...
%\lyt{TODO: I know the use of ``authenticated'' vs. ``unauthenticated'' here was incorrect, since
%even an admin-applied disguise requires authentication as the admin, but I'm not sure what a
%better terminology to use. User-authenticated vs. Admin-authenticated?}
