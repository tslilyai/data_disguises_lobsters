...
\item\textbf{Temporary Recorrelation without Database Changes.}
    \begin{itemize}
        \item \emph{For Disguise Composition}: 
            A disguise targeting a user's data can, if authorized, also operate on data decorrelated
            from the user by prior disguises \emph{without} modifying the links between data and
            owning users in the database.  For example, GDPR account deletion removes user $u$'s
