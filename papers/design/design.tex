...
\head{Storing \symk{pd} and \tdata{pd}.}
...
provide a capability \rptr{pd} in order to locate the encrypted token data from disguise $d$ applied
...
%The client must additionally provide the correct random number generated by \sys in order to
