...
In order to reveal tokens for $p$ from disguise $d$, the client has first produce random number $r$,
...
principal $p$ from observing the array of \tpriv{pdq} ciphertexts. However, \sys can learn how many
