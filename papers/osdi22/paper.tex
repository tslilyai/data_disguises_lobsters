...
\newcommand\tdiff[1]{\ensuremath{\mathcal{T}^{\texttt{diff}}_{#1}}}
\newcommand\town[1]{\ensuremath{\mathcal{T}^{\texttt{own}}_{#1}}}
\newcommand\dcapa[1]{\ensuremath{\mathcal{C}^{\texttt{dec}}_{#1}}}
