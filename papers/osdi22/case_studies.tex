...
to specify disguises; 254LoC to add additional endpoints; and 809LoC added to existing code \lyt{(some of
which were to add e.g., benchmark timings)}. Overall, the process took 1-2 person-days for
...
\sys-Lobsters is a fully E2E application that supports two disguises: GDPR-compliant account
...
The original Lobsters is \lyt{TODO}LoC. We integrate Lobsters with \sys by running \sys as a local
