...
%
We modified \lyt{TODO} lines of code in Lobster's \lyt{TODO} LoC code base
(\lyt{TODO}\%).
%
These modifications took \lyt{TODO} person-days for developers familiar with
...
running example: intructor-initiated answer anonymization, and GDPR-compliant
...
\three{} deletes their contact author relationships to papers; and
...
%
%This account deletion disguise removes a user's relationship to submitted papers,
%but does not remove the papers themselves; a different policy might go even
%further and automatically delete a submission whose last author is scrubbed.
%
