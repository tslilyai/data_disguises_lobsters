...
StoreDiff(p: UID, did: DisguiseID, buffer: Vec<u8>);
...
DiffsForDisguise(did: DisguiseID, privk: PrivKey, loc: Locator, del: bool) -> Vec<Vec<u8>>;
// principals that p speaks for (stored at loc)
PseudoprincipalsOf(p: UID, privk: PrivKey, loc: Locator, del: bool) -> Vec<UID>;
\end{lstlisting}
