...
\end{enumerate}
%
All benchmarks run on a 40-core server with Intel Xeon E5-2660 v3 CPUs and 66MB of RAM 
...
decryptions.
%
\lyt{These all seem to be because of composition (or basically performing ops on
previously-decorrelated data); maybe we should just move exmaples to the next section?}
