...
data.
%
We run Lobsters benchmarks on a database seeded with 17.4k users, 20\% larger
than the late-2021 size of production Lobsters~\cite{lobsters}.
%
...
and \sys removes the public keys for the 1,700 deleted natural principals.
%
