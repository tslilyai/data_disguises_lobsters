...
%
An attacker who compromises the server can immediately observe all application
...
\begin{enumerate}[nosep]
  ...
  \item the number of active natural principals, via \sys's list of
  ...
  \item the number of disguises applied to each pseudoprincipal $q$,
    by observing the size of the $q$'s encrypted locator set.
\end{enumerate}
%
...
account deletions and restorations take \note{X--Y}ms to complete.
%
