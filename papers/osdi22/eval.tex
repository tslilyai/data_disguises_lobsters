...
%
The absolute latency of \sys's disguises is 1.7--7.9ms and the latencies for
\sys's operations over data under disguise are 7.5--10.9ms.
%
...
disguises.
%
\sys takes 37.7--74.3ms to disguise and reveal a user's data, again owing to the
