...
account deletions and restorations with high load respectively take a median of 9 and 15ms to
complete (the rare case of an expensive disguiser requires 2-3 seconds to disguies and reveal). 
%
