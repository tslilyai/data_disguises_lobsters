...
While we have an end-to-end implementation of Lobsters, \lyt{TODO}.
...
Account deletion by both the baseline application and with \sys performs the same DB operations to remove, modify, or
