...
user-provided locator that must necessarily be from $d_1$ that
decorrelated $q$ from natural principal $p$.
%
Following the process in Figure~\ref{f:recursive}, \sys finds the
data for $d_2$ at \lcapa{qd_2} and removes it.
%
