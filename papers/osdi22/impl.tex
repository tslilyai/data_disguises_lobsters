...
necessary in practice.  To implement such a partitioning, \sys uses locators \lcapa{pd} represented
as integer pointers: each \lcapa{pd} points to a bag of either encrypted diff records or encrypted
