...
for (i, ax) in enumerate(axes_flat):
    ...
    filename = "hotcrp_disguise_stats.csv"
    filename_baseline = "hotcrp_disguise_stats_baseline.csv"
    ...
    rects1= ax.bar(X-barwidth, [account_results_baseline, edit_results_baseline, delete_results_baseline, 0,
        anon_results_baseline], color='g', width=barwidth, label="Baseline")
    rects2= ax.bar(X, [account_results, edit_results_noanon, delete_results_noanon, restore_results_noanon, 0],
            color='b', width=barwidth, label="With Edna, Pre-Anonymization")
    rects3=ax.bar(X+barwidth, [account_results, edit_results, delete_results, restore_results, anon_results],
